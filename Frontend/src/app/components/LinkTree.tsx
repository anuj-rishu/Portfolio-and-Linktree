...
export function LinkTree() {
  const links = [
    ...
    },
    {
      ...
      color: "hover:bg-[#1DA1F2]/30",
    },
    {
      name: "Instagram",
      icon: <Instagram size={20} />,
      url: "https://www.instagram.com/anuj_rishu",
      color: "hover:bg-[#E4405F]/30",
    },
  ];
      ...
      <motion.div className="space-y-4" variants={containerVariants}>
        {links.map((link, index) => (
          <motion.a
            ...
            className={`flex items-center justify-center space-x-3 w-full py-3 px-4 bg-white/10 ${link.color} rounded-xl text-white transition-all duration-300 backdrop-blur-sm border border-white/10`}
