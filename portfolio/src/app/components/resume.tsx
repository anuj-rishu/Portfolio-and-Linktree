...
export default function ResumePage() {
  ...
  const publications = [
    {
      title:
        "Global Energy Consumption Patterns and Optimization using Big Data",
      conference:
      ...
      description:
        "Analyzing global energy consumption patterns and leveraging big data for optimization to enhance efficiency, reduce waste, and promote sustainable energy usage.",
  ...
  const skills = {
    ...
    cloud: ["AWS", "Azure", "Firebase", "Vercel", "Netlify"],
    tools: ["Postman", "Docker", "Kubernates" , "GitHub", "Firebase Console", "MongoDB Atlas"],
  };
          ...
          {publications.map((pub, index) => (
            ...
            >
              ...
              <div className="flex gap-4 text-sm text-white/60 mb-4">
                ...
                <span className="flex items-center gap-1">DOI: {pub.doi}</span>
              </div>
